 ...
 */
@WebServlet(urlPatterns = {"/ConsultaArchivo"})
public class ConsultaArchivo extends HttpServlet {
...
public String sendMessage4Json(int Formato, int Estatus, String NumeroEmpleado){
        ...
        String url = "http://10.50.5.155:5000/ConsultaArchivo";
//                 logger.info ("URL de solicitud:" + url);
        try {
            ...
            out = new OutputStreamWriter(conn.getOutputStream(), "UTF-8");
                         // Agregar parámetros
            String json = "{\"NumeroEmpleado\":"+NumeroEmpleado+",\"Formato\":"+Formato+",\"Estatus\":"+Estatus+"}";
