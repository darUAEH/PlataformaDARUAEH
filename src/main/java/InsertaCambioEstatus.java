 ...
 */
@WebServlet(urlPatterns = {"/InsertaCambioEstatus"})
public class InsertaCambioEstatus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println(sendMessage4Json(Integer.valueOf(request.getParameter("Formato")), Integer.valueOf(request.getParameter("Estatus")), String.valueOf(request.getParameter("NumeroEmpleado"))));
        }
    }

    public String sendMessage4Json(int formato, int estatus,String NumeroEmpleado) {
        String jsonData = "";

        OutputStreamWriter out = null;
        BufferedReader in = null;
        StringBuilder result = new StringBuilder();
        String url = "http://10.50.5.155:5000/InsertaCambioEstatus";
//                 logger.info ("URL de solicitud:" + url);
        try {
            ...
            // Agregar parámetros
            String json = "{\"Formato\":" + formato + ",\"Estatus\":" + estatus +  ",\"NumeroEmpleado\":" + NumeroEmpleado + "}";
